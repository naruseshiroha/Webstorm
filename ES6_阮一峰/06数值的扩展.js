...

{
  ...
  */
  ...
  console.log(Number.isSafeInteger(b), Number.isSafeInteger(a), Number.isSafeInteger(''))
}

{
  ...
  */
  ...
  console.log(Number.parseInt(s1), Number.parseInt(s2), Number.parseInt(s3), Number.parseInt(b1))
  console.log(Math.trunc(s1), Math.trunc(s3), Math.trunc(b1), Math.trunc(nu), Math.trunc(un)) // 0 NaN 1 0 NaN
